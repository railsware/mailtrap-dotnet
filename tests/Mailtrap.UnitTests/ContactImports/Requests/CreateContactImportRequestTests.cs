...
[TestFixture]
internal sealed class CreateContactImportRequestTests
{
    [Test]
    public void Constructor_ShouldThrowArgumentNullException_WhenProvidedCollectionIsNull()
    {
        var act = () => new CreateContactImportRequest(null!);
    ...
    {
        var act = () => new CreateContactImportRequest(Array.Empty<ContactImportRequest>());
    ...
    public void Validate_ShouldFail_WhenProvidedCollectionSizeIsInvalid([Values(0, 50001)] int size)
    {
        ...
        var request = size == 0 ? new CreateContactImportRequest() : new CreateContactImportRequest(contacts);
