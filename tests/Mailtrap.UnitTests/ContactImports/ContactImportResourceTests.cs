...
[TestFixture]
internal sealed class ContactImportResourceTests
{
    ...
    {
        // Act
        var act = () => new ContactImportResource(null!, _resourceUri);
    ...
    {
        // Act
        var act = () => new ContactImportResource(_commandFactoryMock, null!);
    ...
    private ContactImportResource CreateResource() => new(_commandFactoryMock, _resourceUri);
}
