...
[TestFixture]
internal sealed class ContactImportCollectionResourceTests
{
    ...
    {
        // Act
        var act = () => new ContactImportCollectionResource(null!, _resourceUri);
    ...
    {
        // Act
        var act = () => new ContactImportCollectionResource(_commandFactoryMock, null!);
    ...
    private ContactImportCollectionResource CreateResource() => new(_commandFactoryMock, _resourceUri);
}
