...
[TestFixture]
internal sealed class InboxCollectionResourceTests
{
    ...
    {
        // Act
        var act = () => new InboxCollectionResource(null!, _resourceUri);
    ...
    {
        // Act
        var act = () => new InboxCollectionResource(_commandFactoryMock, null!);
    ...
    public void ResourceUri_ShouldBeInitializedProperly()
    {
        ...
        // Assert
        client.ResourceUri.Should().Be(_resourceUri.Append(UrlSegmentsTestConstants.InboxesSegment));
    }
    ...
    private InboxCollectionResource CreateResource() => new(_commandFactoryMock, _resourceUri);
}
