// -----------------------------------------------------------------------
// <copyright file="EmailCollectionResourceTests.cs" company="Railsware Products Studio, LLC">
...
[TestFixture]
internal sealed class EmailCollectionResourceTests
{
    ...
    {
        // Act
        var act = () => new EmailCollectionResource(null!, _resourceUri);
    ...
    {
        // Act
        var act = () => new EmailCollectionResource(_commandFactoryMock, null!);
    ...
    private EmailCollectionResource CreateResource() => new(_commandFactoryMock, _resourceUri);
}
