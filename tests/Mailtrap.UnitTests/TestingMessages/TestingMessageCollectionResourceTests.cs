...
[TestFixture]
internal sealed class TestingMessageCollectionResourceTests
{
    ...
    {
        // Act
        var act = () => new TestingMessageCollectionResource(null!, _resourceUri);
    ...
    {
        // Act
        var act = () => new TestingMessageCollectionResource(_commandFactoryMock, null!);
    ...
    private TestingMessageCollectionResource CreateResource() => new(_commandFactoryMock, _resourceUri);
}
