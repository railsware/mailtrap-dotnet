...
[TestFixture]
internal sealed class ContactsEventCollectionResourceTests
{
    ...
    {
        // Act
        var act = () => new ContactsEventCollectionResource(null!, _resourceUri);
    ...
    {
        // Act
        var act = () => new ContactsEventCollectionResource(_commandFactoryMock, null!);
    ...
    private ContactsEventCollectionResource CreateResource() => new(_commandFactoryMock, _resourceUri);
}
