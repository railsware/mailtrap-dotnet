...
[TestFixture]
internal sealed class ProjectCollectionResourceTests
{
    ...
    {
        // Act
        var act = () => new ProjectCollectionResource(null!, _resourceUri);
    ...
    {
        // Act
        var act = () => new ProjectCollectionResource(_commandFactoryMock, null!);
    ...
    private ProjectCollectionResource CreateResource() => new(_commandFactoryMock, _resourceUri);
}
