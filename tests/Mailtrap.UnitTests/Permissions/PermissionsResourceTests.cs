...
[TestFixture]
internal sealed class PermissionsResourceTests
{
    ...
    private readonly Uri _resourceUri = EndpointsTestConstants.ApiDefaultUrl
        ...
        .Append(UrlSegmentsTestConstants.PermissionsSegment);
    ...
    {
        // Act
        var act = () => new PermissionsResource(null!, _resourceUri);
    ...
    {
        // Act
        var act = () => new PermissionsResource(_commandFactoryMock, null!);
    ...
    private PermissionsResource CreateResource() => new(_commandFactoryMock, _resourceUri);
}
