...
[TestFixture]
internal sealed class ContactListResourceTests
{
    ...
    {
        // Act
        var act = () => new ContactListResource(null!, _resourceUri);
    ...
    {
        // Act
        var act = () => new ContactListResource(_commandFactoryMock, null!);
    ...
    private ContactListResource CreateResource() => new(_commandFactoryMock, _resourceUri);
}
