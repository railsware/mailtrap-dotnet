...
[TestFixture]
internal sealed class ContactsListCollectionResourceTests
{
    ...
    {
        // Act
        var act = () => new ContactsListCollectionResource(null!, _resourceUri);
    ...
    {
        // Act
        var act = () => new ContactsListCollectionResource(_commandFactoryMock, null!);
    ...
    private ContactsListCollectionResource CreateResource() => new(_commandFactoryMock, _resourceUri);
}
