...
[TestFixture]
internal sealed class ContactsListResourceTests
{
    ...
    {
        // Act
        var act = () => new ContactsListResource(null!, _resourceUri);
    ...
    {
        // Act
        var act = () => new ContactsListResource(_commandFactoryMock, null!);
    ...
    private ContactsListResource CreateResource() => new(_commandFactoryMock, _resourceUri);
}
