...
[TestFixture]
internal sealed class EmailTemplateCollectionResourceTests
{
    ...
    {
        // Act
        var act = () => new EmailTemplateCollectionResource(null!, _resourceUri);
    ...
    {
        // Act
        var act = () => new EmailTemplateCollectionResource(_commandFactoryMock, null!);
    ...
    private EmailTemplateCollectionResource CreateResource() => new(_commandFactoryMock, _resourceUri);
}
