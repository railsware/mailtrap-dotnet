...
[TestFixture]
internal sealed class ContactsFieldCollectionResourceTests
{
    ...
    {
        // Act
        var act = () => new ContactsFieldCollectionResource(null!, _resourceUri);
    ...
    {
        // Act
        var act = () => new ContactsFieldCollectionResource(_commandFactoryMock, null!);
    ...
    private ContactsFieldCollectionResource CreateResource() => new(_commandFactoryMock, _resourceUri);
}
