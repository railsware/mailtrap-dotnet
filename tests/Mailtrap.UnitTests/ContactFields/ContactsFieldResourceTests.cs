...
[TestFixture]
internal sealed class ContactsFieldResourceTests
{
    ...
    {
        // Act
        var act = () => new ContactsFieldResource(null!, _resourceUri);
    ...
    {
        // Act
        var act = () => new ContactsFieldResource(_commandFactoryMock, null!);
    ...
    private ContactsFieldResource CreateResource() => new(_commandFactoryMock, _resourceUri);
}
