...
[TestFixture]
internal sealed class UpdateContactsFieldRequestTests
{
    [Test]
    public void CopyConstructor_ShouldUpdateFieldsCorrectly()
    {
        ...
        var originalRequest = new UpdateContactsFieldRequest("validName", "validMergeTag");
    ...
    {
        var act = () => new UpdateContactsFieldRequest(null!, null!);
    ...
    {
        var act = () => new UpdateContactsFieldRequest(string.Empty, string.Empty);
    ...
    public void Constructor_ShouldInitializeFieldsCorrectly_WhenNameIsNull()
    {
        ...
        // Act
        var request = new UpdateContactsFieldRequest(null!, mergeTag);
    ...
    public void Constructor_ShouldInitializeFieldsCorrectly_WhenNameIsEmpty()
    {
        ...
        // Act
        var request = new UpdateContactsFieldRequest(string.Empty, mergeTag);
    ...
    public void Constructor_ShouldInitializeFieldsCorrectly_WhenMergeTagIsNull()
    {
        ...
        // Act
        var request = new UpdateContactsFieldRequest(name, null!);
    ...
    public void Constructor_ShouldInitializeFieldsCorrectly_WhenMergeTagIsEmpty()
    {
        ...
        // Act
        var request = new UpdateContactsFieldRequest(name, string.Empty);
    ...
    public void Validate_ShouldFail_WhenProvidedNameLengthIsInvalid([Values(81)] int length)
    {
        ...
        var request = new UpdateContactsFieldRequest(name, "validMergeTag");
    ...
    public void Validate_ShouldFail_WhenProvidedMergeTagLengthIsInvalid([Values(81)] int length)
    {
        ...
        var request = new UpdateContactsFieldRequest("validName", mergeTag);
