...
[TestFixture]
internal sealed class AccountAccessResourceTests
{
    ...
    {
        // Act
        var act = () => new AccountAccessResource(null!, _resourceUri);
    ...
    {
        // Act
        var act = () => new AccountAccessResource(_commandFactoryMock, null!);
    ...
    private AccountAccessResource CreateResource() => new(_commandFactoryMock, _resourceUri);
}
