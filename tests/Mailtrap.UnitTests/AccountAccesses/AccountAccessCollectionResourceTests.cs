...
[TestFixture]
internal sealed class AccountAccessCollectionResourceTests
{
    ...
    {
        // Act
        var act = () => new AccountAccessCollectionResource(null!, _resourceUri);
    ...
    {
        // Act
        var act = () => new AccountAccessCollectionResource(_commandFactoryMock, null!);
    ...
    private AccountAccessCollectionResource CreateResource() => new(_commandFactoryMock, _resourceUri);
}
