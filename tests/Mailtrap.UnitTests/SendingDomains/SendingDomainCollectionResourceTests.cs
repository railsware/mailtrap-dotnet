...
[TestFixture]
internal sealed class SendingDomainCollectionResourceTests
{
    ...
    {
        // Act
        var act = () => new SendingDomainCollectionResource(null!, _resourceUri);
    ...
    {
        // Act
        var act = () => new SendingDomainCollectionResource(_commandFactoryMock, null!);
    ...
    private SendingDomainCollectionResource CreateResource() => new(_commandFactoryMock, _resourceUri);
}
