...
[TestFixture]
internal sealed class SendingDomainResourceTests
{
    ...
    {
        // Act
        var act = () => new SendingDomainResource(null!, _resourceUri);
    ...
    {
        // Act
        var act = () => new SendingDomainResource(_commandFactoryMock, null!);
    ...
    private SendingDomainResource CreateResource() => new(_commandFactoryMock, _resourceUri);
}
