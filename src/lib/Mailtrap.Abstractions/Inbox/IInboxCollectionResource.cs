...
public interface IInboxCollectionResource
{
    ...
    /// </returns>
    public Task<CollectionResponse<InboxDetails>> GetAll(CancellationToken cancellationToken = default);
    ...
    /// </returns>
    public Task<Response<InboxDetails>> Create(CreateInboxRequest request, CancellationToken cancellationToken = default);
}
