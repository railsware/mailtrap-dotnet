...
public interface IInboxResource
{
    ...
    /// </returns>
    public Task<Response<InboxDetails>> GetDetails(CancellationToken cancellationToken = default);
    ...
    /// </returns>
    public Task<Response<InboxDetails>> Update(UpdateInboxRequest request, CancellationToken cancellationToken = default);
    ...
    /// </returns>
    public Task<Response<InboxDetails>> Clean(CancellationToken cancellationToken = default);
    ...
    public Task<Response<InboxDetails>> MarkAsRead(CancellationToken cancellationToken = default);
    ...
    /// 
    /// <inheritdoc cref="Clean(CancellationToken)" path="/returns"/>
    public Task<Response<InboxDetails>> ResetCredentials(CancellationToken cancellationToken = default);
    ...
    /// 
    /// <inheritdoc cref="Clean(CancellationToken)" path="/returns"/>
    public Task<Response<InboxDetails>> ToggleEmailAddress(CancellationToken cancellationToken = default);
    ...
    /// 
    /// <inheritdoc cref="Clean(CancellationToken)" path="/returns"/>
    public Task<Response<InboxDetails>> ResetEmailAddress(CancellationToken cancellationToken = default);
}
