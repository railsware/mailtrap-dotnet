...
public static class SendEmailRequestBuilder
{
    ...
    ///
    /// <remarks>
    /// Subsequent calls will override value that was set before (last wins).<br />
    /// </remarks>
    ...
    /// recipient collection in <paramref name="request"/>.
    /// </summary>
    ///
    /// <param name="request">
    /// <inheritdoc cref="From(SendEmailRequest, EmailAddress)" path="/param[@name='request']"/>
    ...
    /// to the <see cref="SendEmailRequest.To"/> recipient collection in <paramref name="request"/>.
    /// </summary>
    ///
    /// <param name="request">
    ...
    /// <summary>
    /// Adds provided <paramref name="email"/> and <paramref name="displayName"/> tuple as recipient
    /// to the <see cref="SendEmailRequest.Cc"/> recipient collection in <paramref name="request"/>.
    /// </summary>
    ///
    /// <param name="request">
    ...
    /// <summary>
    /// Adds provided <paramref name="email"/> and <paramref name="displayName"/> tuple as recipient
    /// to the <see cref="SendEmailRequest.Bcc"/> recipient collection in <paramref name="request"/>.
    /// </summary>
    ///
    /// <param name="request">
    /// <inheritdoc cref="To(SendEmailRequest, string, string?)" path="/param[@name='request']"/>
    ...
    /// collection in <paramref name="request"/>.
    /// </summary>
    ///
    /// <param name="request">
    /// <inheritdoc cref="From(SendEmailRequest, EmailAddress)" path="/param[@name='request']"/>
