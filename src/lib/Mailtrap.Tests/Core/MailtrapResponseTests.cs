// -----------------------------------------------------------------------
// <copyright file="MailtrapResponseTests.cs" company="Railsware Products Studio, LLC">
...
[TestFixture]
internal sealed class MailtrapResponseTests
{
    [Test]
    public void Constructor_ShouldProperlyInitializeProperties_WhenSuccess()
    {
        var response = new MailtrapResponse<string>(true);
    ...
    public void Constructor_ShouldProperlyInitializeProperties_WhenError()
    {
        ...
        var response = new MailtrapResponse<string>(false, errorMessage);
