...
[assembly: SuppressMessage("Usage", "CA2227:Collection properties should be read only", Justification = "DTO; nullable setter required to distinguish 'unchanged' from 'set to empty'", Scope = "member", Target = "~P:Mailtrap.EmailCampaigns.Requests.CreateEmailCampaignRequest.ContactListIds")]
[assembly: SuppressMessage("Usage", "CA2227:Collection properties should be read only", Justification = "DTO; nullable setter required to distinguish 'unchanged' from 'set to empty'", Scope = "member", Target = "~P:Mailtrap.EmailCampaigns.Requests.CreateEmailCampaignRequest.ContactSegmentIds")]
[assembly: SuppressMessage("Usage", "CA2227:Collection properties should be read only", Justification = "DTO; nullable setter required to distinguish 'unchanged' from 'set to empty' on PATCH", Scope = "member", Target = "~P:Mailtrap.EmailCampaigns.Requests.UpdateEmailCampaignRequest.ContactListIds")]
[assembly: SuppressMessage("Usage", "CA2227:Collection properties should be read only", Justification = "DTO; nullable setter required to distinguish 'unchanged' from 'set to empty' on PATCH", Scope = "member", Target = "~P:Mailtrap.EmailCampaigns.Requests.UpdateEmailCampaignRequest.ContactSegmentIds")]
[assembly: SuppressMessage("Usage", "CA2227:Collection properties should be read only", Justification = "DTO; nullable setter required to distinguish 'unchanged' from 'replaced as a whole'", Scope = "member", Target = "~P:Mailtrap.EmailCampaigns.Requests.EmailCampaignTemplateAttributes.MergeTags")]
